const pages = [
    ...
    {
        output: './recomendação-compra-futura.html',
        content: {
            title: 'Recomendação de compras para o próximo mês',
            description: 'Com base no padrão de vendas do seu estoque recomendamos as seguintes compras para o mês que vem:',
